...
public class ExampleWall {private final Context context;
...
final String fragmentShader =
        ...
        +   "   vec4 baseColor1; \n"
        +   "   baseColor1 = texture2D(u_Texture1, v_TexCoordinate1);      \n" 
     +   "   gl_FragColor = baseColor*baseColor1*2.0;   \n"	
		+ "} \n";
...
public ExampleWall(Context context,float s){
		...
		int programHandle = GLES20.glCreateProgram();
			...
			GLES20.glBindAttribLocation(programHandle, 2, "a_TexCoordinate1");
		...
		final int[] linkStatus = new int[1];
			...
			System.out.println("error 1");
			        ...
			        mTextureHandle1=GLES20.glGetAttribLocation(programHandle, "a_TexCoordinate1");
			        GLES20.glUseProgram(programHandle);
